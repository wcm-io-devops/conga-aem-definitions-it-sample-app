package io.wcm.devops.conga.definitions.it.sample.config;
...
public enum AppTemplate implements TemplatePathInfo {
   ...
   * Structure element
   */
  ADMIN_STRUCTURE_ELEMENT("/apps/aemdef-it-sample/core/templates/admin/structureElement"),

  /**
   * Redirect
   */
  ADMIN_REDIRECT("/apps/aemdef-it-sample/core/templates/admin/redirect"),

  /**
   * Content page
   */
  CONTENTPAGE("/conf/aemdef-it-sample/settings/wcm/templates/contentpage"),

  /**
   * Home page
   */
  HOMEPAGE("/conf/aemdef-it-sample/settings/wcm/templates/homepage");
